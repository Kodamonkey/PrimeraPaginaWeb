<?php
    ...
    $id = (isset($_GET['pelicula_id_calificar'])) ? $_GET['pelicula_id_calificar'] : 0;
...
<div class="container pb-6 pt-6">
	<?php
        ...
        $cont = $connection->fetchAll();

        if(($connection->rowCount() == 1) && ($connection_review->rowCount() == 0)){
            foreach($cont as $rows){
                if($id == $rows['id_pelicula']){
    ?>
                    <div class="tile is-child box">
                        <center><h1 class="title">Califique Una pelicula </h1></center>
                    </div>
                            ...
                            <div class="columns">
                                <div class="column">
                                    <div class="control">
                                        ...
                                        <input class="input" type="number" name="puntuacion" pattern="[0-5]" placeholder = "ejemplo: 4.1" required>
                                    </div>
                                </div>
                            </div>
                            <div class="columns">
                                <div class="column">
                                    <div class="control">
                                        ...
                                        <input class="input" type="text" name="reseña" maxlength="100">
                                    </div>
                                </div>
                            </div>
    ...
    <?php                
            ...
            echo '
                ...
                <p class="has-text-centered mb-4 mt-3">
                    <a type="button"  class="button is-link is-rounded" href="index.php?vista=mis_reseñas">Ver mis reseñas</a>
                </p>
                ';
        }
		$check_usuario = null;
