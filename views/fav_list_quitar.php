...
<div class="title is-child box">
    <center><h1 class="title">Quitar película de la Favlist</h1></center>
</div>
...
<div class="container pb-6 pt-6">
	...
	<?php
        ...
        if($connection->rowCount() == 1){
            ...
            $connection_1 = $check_usuario->query("DELETE FROM fav_list WHERE (id_usuario = $id_user_actual AND id_pelicula = $id)");
