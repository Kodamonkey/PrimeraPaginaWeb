...
<div class="container pb-6 pt-6">
    ...
    <p class="has-text-right pt-4 pb-4">
        <a href="index.php?vista=mis_seguidores" class="button is-link is-rounded btn-back"><- Regresar atrás</a>
    </p>
    <div class="tile is-child box">
    ...
    <div class="box">
        <form action="" method="POST" autocomplete="off">
            ...
            <div class="field-data">
                ...
                <br>
                <center><label class="label">Email: <?php echo " ".$datos['email_usuario'];?></label></center>
                <br>
                <br>
                ...
                <br>
                <br>
                <center><label class="label">Rentadas Historicamente:<?php echo " ".$datos['rentadas_actualmente'];?></label></center>
                <center><label class="label">Rentadas Actualmente:<?php echo " ".$datos['rentadas_historicamente'];?></label></center>
                <div class="field-data">
                ...
                <p class="has-text-center pt-4 pb-4">
                    <center><a href="index.php?vista=reseñas_seguidores&id_seguidores_reseñas=<?php echo $datos['id_usuario'];?>" class= "button is-info">Ver sus reseñas</a></center>
                </p>
            </div>
