...
<div class="container pb-6 pt-6">
    <p class="has-text-right pt-4 pb-4">
        <a href="index.php?vista=buscador_usuarios" class="button is-link is-rounded btn-back"><- Regresar atrás</a>
    </p>
	<?php
        /*== Verificando usuario ==*/
        ...
        <form action="" method="POST" autocomplete="off">
            ...
            <div class="field-data">
                ...
                <p class="has-text-center pt-4 pb-4">
                    <center><a href="index.php?vista=reseñas_seguidos_buscador&id_seguidos_reseñas=<?php echo $datos['id_usuario'];?>" class= "button is-info">Ver sus reseñas</a></center>
                </p>
            </div>
        </form>
    </div>
